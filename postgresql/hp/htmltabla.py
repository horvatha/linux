...
href="http://mail.roik.bmf.hu/harp/web/styles/stilus.css">
</head>
<body>
"""

def html_tablazat(elemek, oszlopok_szama=None, fejlec=None, colgroup=False):
...
def html(table, connection):
    ...
    return "\n".join(html_tablazat(eredmeny, fejlec=attr_names(table, connection)))
